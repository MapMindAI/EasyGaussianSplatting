...
# against. The default resolves to the Docker host, for a server started on
# this machine by third_party/EasyTensorRT/run_server_onnx.sh.
TRITON_URL="${TRITON_URL:-host.docker.internal:8001}"
